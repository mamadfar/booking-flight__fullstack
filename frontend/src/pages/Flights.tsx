        ...
        <Row className="flex-col w-full lg:w-3/4 xl:w-3/5 mx-auto">
            {flights.map((flight, index) => (
                <div key={index}>
                    ...
                    <Collapse className="bg-gray-100 flex justify-center rounded-t-none" expandIconPosition="end" ghost>
                        <Panel className="w-full flex flex-col h-fit items-center border-0" header="Flight Details" key="1">
                                ...
                                <div key={index} className="mb-5">
                                    ...
                                    <Row className="flex-col sm:flex-row space-y-3 sm:space-y-0 justify-between">
                                        <Row className="flex-col flex-1 leading-6">
                                            ...
                                            <p><small className="font-bold">Aircraft:</small> {flightDetail.Aircraft}
                                            </p>
                                            <p><small className="font-bold">Class:</small> {flightDetail.FlightClass}
                                            </p>
                                            <p><small className="font-bold">Baggage:</small> {flightDetail.Baggage}</p>
                                        </Row>
                                        <Row className="flex-col flex-1 leading-6">
